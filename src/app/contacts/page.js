  ...
  return (
    <div className="w-full relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-20">
        <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 1 }} className="max-w-3xl mx-auto text-center mb-16">
        ...
        <div className="grid lg:grid-cols-12 gap-8 lg:gap-12 items-start">{/* карточки с контактами */}
          ...
          <motion.div initial={{ opacity: 0, x: 50 }} animate={{ opacity: 1, x: 0 }}
            ...
            <div className="relative w-full h-[450px] lg:h-full min-h-[550px] rounded-[2rem] overflow-hidden shadow-2xl shadow-slate-200 border-[6px] border-white group">
              <div className="absolute inset-0 bg-slate-100 flex items-center justify-center -z-10">
                <motion.div animate={{ scale:[1, 1], opacity: [0.5, 1, 0.5] }} transition={{ duration: 2, repeat: Infinity }}>
                  <MapPin size={48} className="text-slate-300" />
                </motion.div>
              </div>
              <iframe src="https://yandex.ru/map-widget/v1/?ll=140.2955%2C48.9682&z=17&pt=140.2955%2C48.9682%2Cpm2rdm" 
              ...
              <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 1.2, duration: 0.6 }}
                ...
                <a href="https://yandex.ru/maps/?rtext=~48.9682,140.2955" target="_blank" rel="noopener noreferrer"
