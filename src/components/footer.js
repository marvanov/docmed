...
export default function Footer() {
  ...
  useEffect(() => {
    const handleScroll = () => {// достигли ли мы конца страницы/// с запасом в 50px
  ...
  const scrollToBottom = () => {if (!isExpanded) window.scrollTo({ top: document.body.offsetHeight, behavior: "smooth", });};
  ...
  return (
    <>
      ...
      <motion.footer ref={footerRef}
        ...
        initial={false} animate={{ height: isExpanded ? "auto" : "72px" }}
