    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex justify-between items-center">
        ...
        <nav className="hidden md:flex items-center gap-8">
          ...
          <button className="flex items-center gap-2 px-4 py-2 rounded-full border border-teal-600 text-teal-600 text-sm font-medium hover:bg-teal-600 hover:text-white transition-all duration-300">
            <Eye size={16} />
        ...
        {mobileMenuOpen && (
          ...
          >
            <div className="flex flex-col gap-4">
              ...
              <button className="flex items-center gap-2 text-teal-600 text-lg font-medium mt-4">
                <Eye size={20} />
